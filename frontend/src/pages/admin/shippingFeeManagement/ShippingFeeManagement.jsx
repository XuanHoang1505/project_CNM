...
const ShippingFeeManagement = () => {
    ...
    const shippingFeeColumns = [
        { key: "id", label: "ID" },
        { key: "province_name", label: "Province/City" },
        { key: "province_code", label: "Province Code" },
        { key: "ward_name", label: "Ward/Commune" },
        { key: "ward_code", label: "Ward Code" },
        { key: "fee", label: "Shipping Fee (VND)" },
        { key: "note", label: "Note" },
    ];
    ...
    const handleSaveItem = async () => {
        ...
        try {
            ...
            if (statusFunction.isEditing) {
                ...
                // Đảm bảo fee là số
                const feeValue = typeof formData.fee === 'string'
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                    <select
                        ...
                        disabled={!selectedProvince || isLoadingWards || statusFunction.isViewDetail}
                        className="w-full px-3 py-2 border rounded"
                    >
                        <option value="">
